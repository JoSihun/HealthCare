...
const InputForm = (props) => {
    ...
    const handleSubmit = async (e) => {
        ...
        .then((response) => {
            window.location.assign(`/support/qnaboard/post/${response}`)
        }).catch((error) => {
            console.log(error)
        });
        ...
        //     },
        // }).then((response) => {
        //     window.location.assign(`/support/qnaboard/post/${id}`);
        // }).catch((error) => {
        //     console.log(error);
        // });
        ...
        //     },
        // }).then((response) => {
        //     window.location.assign(`/support/qnaboard/post/${response.data}`);
        // }).catch((error) => {
        //     console.log(error);
        // })
    }
